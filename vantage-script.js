...
function handleButtonClick(buttonId) {
    localStorage.setItem('lastClickedButton', buttonId); // Armazena o ID do botão clicado
    window.location.href = "index.html"; // Navega para a página index.html
}

// Marca o botão como confirmado ao carregar a página principal
function loadState() {
    const lastClickedButtonId = localStorage.getItem('lastClickedButton');
    if (lastClickedButtonId) {
        ...
        localStorage.removeItem('lastClickedButton'); // Limpa o estado
    }
}
...
document.getElementById('reset-btn').addEventListener('click', resetButtons);
